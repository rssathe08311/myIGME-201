    ...
    public partial class LinkedList : Form
    {
       ...
       */
        ...
        private void Button3__Click(object sender, EventArgs e)
        {
            ...
            // 3. add "quick" and "brown" before "fox" // 4. Your code here
        ...
        private void Button4__Click(object sender, EventArgs e)
        {
            ...
            // 2. Your code here
            string sent = "Because I'm sad Clap along if you feel like a room without a roof";
            sent += " Because I'm sad Clap along if you feel like sadness is the truth sad";
            s = sent.Split(' ');
            ...
            while (linkedListNode != null)
            {
                if (linkedListNode.Value is string stringValue)
                {
                    if ((string)linkedListNode.Value == "sad")
                    {
        ...
        private void Button5__Click(object sender, EventArgs e)
        {
            ...
            // 2. Your code here
            string sent = "The Spain in rain falls plain on the mainly";
            s = sent.Split(' '); 
            linkedList = new LinkedList<object>(s);
