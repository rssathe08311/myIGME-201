    ...
    static internal class Program
    {
        ...
        static void Main(string[] args)
        {
...

            {
                ...
                //cannot access myString outside of the codeblock above
            }
            ...
            //tryParse is something to use in a try catch statement will throw an error if not possible 
           ...
           //do while loop
            ...
            switch (sFavCol.ToLower())//sets the string to all lower case
            {
                case "red":
                //case "RED":
                //case "Red":
            ...
            y = ++x;//will first incriment x so x = 6, then y will be set equal to 6, both y and x are = 6
            y = x++; //will first set y = 5 then will incriment x, so y = 5, x = 6

            for(int i = 0; i < nFavNum; ++i)
            {
                Console.WriteLine("Your Favorite Color is " + sFavCol + "!");
                Console.WriteLine($"Your Favorite Color is { sFavCol} !");//string interpolation
                Console.WriteLine($"Your Favorite Color is {0}{1}", sFavCol, "!");
